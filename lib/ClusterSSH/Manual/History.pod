...
always control the terminals.  It also had to have root Setuid permissions
which I knew the IT Security team wouldn't like,

So, a while later, I rewrote some of the fundamental terminal control 
code and called it Version 2.  Some of my colleges had found out about it 
and had started using it, giving feedback for improvements.  One 
