...
$host = ClusterSSH::Host->parse_host_string('hostname');
isa_ok( $host, "ClusterSSH::Host" );
is( $host,               'hostname', 'stringify works' );
is( $host->get_hostname, 'hostname', 'checking set works' );
is( $host->get_port,     undef,      'checking set works' );
...
$host = ClusterSSH::Host->parse_host_string('hostname:2323');
isa_ok( $host, "ClusterSSH::Host" );
is( $host,               'hostname', 'stringify works' );
is( $host->get_hostname, 'hostname', 'checking set works' );
is( $host->get_port,     2323,       'checking set works' );
...
$host = ClusterSSH::Host->parse_host_string('username@hostname:2323');
isa_ok( $host, "ClusterSSH::Host" );
...
$host = ClusterSSH::Host->parse_host_string('username@hostname');
isa_ok( $host, "ClusterSSH::Host" );
is( $host,               'hostname', 'stringify works' );
is( $host->get_hostname, 'hostname', 'checking set works' );
is( $host->get_port,     undef,      'checking set works' );
...
$host = ClusterSSH::Host->parse_host_string('127.0.0.1');
isa_ok( $host, "ClusterSSH::Host" );
...
$host = ClusterSSH::Host->parse_host_string('127.0.0.1:2323');
isa_ok( $host, "ClusterSSH::Host" );
...
$host = ClusterSSH::Host->parse_host_string('username@127.0.0.1:2323');
isa_ok( $host, "ClusterSSH::Host" );
...
$host = ClusterSSH::Host->parse_host_string('username@127.0.0.1');
isa_ok( $host, "ClusterSSH::Host" );
...
$host = ClusterSSH::Host->parse_host_string('::1');
isa_ok( $host, "ClusterSSH::Host" );
...
$host = ClusterSSH::Host->parse_host_string('username@::1');
isa_ok( $host, "ClusterSSH::Host" );
is( $host,               '::1',      'stringify works' );
is( $host->get_hostname, '::1',      'checking set works' );
is( $host->get_port,     undef,      'port is undef' );
...
$host = ClusterSSH::Host->parse_host_string('[::1]:22');
isa_ok( $host, "ClusterSSH::Host" );
is( $host,               '::1', 'stringify works' );
is( $host->get_hostname, '::1', 'checking set works' );
...
$host = ClusterSSH::Host->parse_host_string('username@[::1]:22');
isa_ok( $host, "ClusterSSH::Host" );
is( $host,               '::1',      'stringify works' );
is( $host->get_hostname, '::1',      'checking set works' );
is( $host->get_port,     22,         'checking port set' );
